...
//     return error.message; // Si es un error estándar, devolvemos su mensaje
//   }
//   return 'Ocurrió un error desconocido'; // Si el error no es un Error, devolvemos un mensaje genérico
// };
